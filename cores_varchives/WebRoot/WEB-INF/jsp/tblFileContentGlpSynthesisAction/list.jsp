...
<script type="text/javascript">
    	$(function(){
			...
			$('#tblFileContentGlpSynthesisDatagrid').datagrid({
			...
			var pager = $('#tblFileContentGlpSynthesisDatagrid').datagrid('getPager');    // get the pager of datagrid
		   	var opts = $('#tblFileContentGlpSynthesisDatagrid').datagrid('options');
	    	pager.pagination({
	          showRefresh:false,
	          loading:true,
			 ...
			 parent.parent.$('#department').combobox({
 						valueField:'id',
 						textField:'name',
 						 editable:false,
 	 					url:sybp()+'/tblFileContentGlpSynthesisAction_getDepartmentList.action'				 
	 				 });
			 parent.parent.$('#oneArchiveMaker3').combobox({
 	 					 valueField:'realName',
 	 					 textField:'realName',
 	 					 editable:false,
			 ...
			 parent.parent.$('#oneStorePosition3').combotree({
				 valueField:'text',
				 textField:'text',
				 editable:true,
...
<body >
	<div class="container">
       ...
       <div style="display:block; position:absolute;top:0px;left:0px;right:0px; bottom:0px;background:#fff;padding:0px 0px 0px 0px;overflow:hidden;" >
 	 	 ...
 	 	 <div id="tblFileContentGlpSynthesisDatagrid" class="easyui-datagrid" style="border: 1px solid #c8c8c8;" border="false" >
