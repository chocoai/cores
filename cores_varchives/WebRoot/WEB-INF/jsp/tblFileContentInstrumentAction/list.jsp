...
<script type="text/javascript">
    	$(function(){
    		...
    		var tableWidth  = document.body.clientWidth-2;
   	   	 	$('#tblFileContentInstrumentDatagrid').datagrid({
	           ...
	           // collapsible : true,//显示可折叠按钮 
				...
				onDblClickRow:function(rowIndex, rowData){//查看
					parent.parent.newOneInstrument(4);
				},
   	   	...
   	   	var pager = $('#tblFileContentInstrumentDatagrid').datagrid('getPager');    // get the pager of datagrid
	   	var opts = $('#tblFileContentInstrumentDatagrid').datagrid('options');
    	pager.pagination({
          showRefresh:false,
          loading:true,
          onSelectPage:function(pageNum, pageSize){
			...
			if(contentWind.$)
			 ...
			 parent.parent.$('#oneArchiveMaker4').combobox({
					 valueField:'realName',
					 textField:'realName',
					 editable:false,
			 ...
			 parent.parent.$('#oneStorePosition4').combotree({
				 valueField:'text',
				 textField:'text',
				 editable:true,
...
<body >
	<div class="container">
       ...
       <div style="display:block; position:absolute;top:0px;left:0px;right:0px; bottom:0px;background:#fff;padding:0px 0px 0px 0px;overflow:hidden;" >
 	 	 ...
 	 	 <div id="tblFileContentInstrumentDatagrid" class="easyui-datagrid" style="border: 1px solid #c8c8c8;" border="false" >
