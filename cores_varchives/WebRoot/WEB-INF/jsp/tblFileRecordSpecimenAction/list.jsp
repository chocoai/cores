...
<script type="text/javascript">
    	$(function(){
    		...
    		var tableWidth  = document.body.clientWidth-2;
   	   	 	$('#tblFileRecordSpecimenDatagrid').datagrid({
	           ...
	           frozenColumns:[[
				...
				onDblClickRow:function(rowIndex, rowData){//查看
					parent.parent.newOneSpecimen(4);
				},
   	   	...
   	   	var pager = $('#tblFileRecordSpecimenDatagrid').datagrid('getPager');    // get the pager of datagrid
	   	var opts = $('#tblFileRecordSpecimenDatagrid').datagrid('options');
    	pager.pagination({
          showRefresh:false,
          loading:true,
          onSelectPage:function(pageNum, pageSize){
			...
			if(contentWind.$)
			 ...
			 parent.parent.$('#sdSpecimen').combobox({
				 valueField:'realName',
				 textField:'realName',
				 editable:false,
				 url:sybp()+'/tblFileRecordSpecimenAction_getSDList.action'
			 });
			 parent.parent.$('#oneStorePosition9').combotree({
				 valueField:'text',
				 textField:'text',
				 editable:true,
...
<body >
	<div class="container">
        <div>
        	<a class="easyui-linkbutton" onclick="parent.parent.openSearchSpecimenCodeDialog();"  data-options="iconCls:'icon-search',plain:true">标本编号速查</a>
					
        </div>
       <div style="display:block; position:absolute;top:30px;left:0px;right:0px; bottom:0px;background:#fff;padding:0px 0px 0px 0px;overflow:hidden;" >
 	 	 
 	 	 <div id="tblFileRecordSpecimenDatagrid" class="easyui-datagrid" style="border: 1px solid #c8c8c8;" border="false" >
