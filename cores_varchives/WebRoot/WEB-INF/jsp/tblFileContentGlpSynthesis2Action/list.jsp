...
<script type="text/javascript">
    	$(function(){
			...
			$('#tblFileContentGlpSynthesis2Datagrid').datagrid({
	           ...
	           // collapsible : true,//显示可折叠按钮 
				...
				onDblClickRow:function(rowIndex, rowData){//查看
					parent.parent.newOneGlpSynthesis(4);
				},
			...
			var pager = $('#tblFileContentGlpSynthesis2Datagrid').datagrid('getPager');    // get the pager of datagrid
		   	var opts = $('#tblFileContentGlpSynthesis2Datagrid').datagrid('options');
	    	pager.pagination({
	          showRefresh:false,
	          loading:true,
			 ...
			 parent.parent.$('#department2').combobox({
 						valueField:'id',
 						textField:'name',
 						editable:false,
 	 					url:sybp()+'/tblFileContentGlpSynthesisAction_getDepartmentList.action'				 
	 				 });
			 parent.parent.$('#oneArchiveMaker10').combobox({
 	 					 valueField:'realName',
 	 					 textField:'realName',
 	 					 editable:false,
			 ...
			 parent.parent.$('#oneStorePosition10').combotree({
				 valueField:'text',
				 textField:'text',
				 editable:true,
...
<body >
	<div class="container">
       ...
       <div style="display:block; position:absolute;top:0px;left:0px;right:0px; bottom:0px;background:#fff;padding:0px 0px 0px 0px;overflow:hidden;" >
 	 	 ...
 	 	 <div id="tblFileContentGlpSynthesis2Datagrid" class="easyui-datagrid" style="border: 1px solid #c8c8c8;" border="false" >
