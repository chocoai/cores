...
public interface TblAnatomyTaskService extends BaseDao<TblAnatomyTask> {
	 ...
	 * 课题编号，解剖任务序号，任务id，任务创建日期（yyyy-MM-dd）；以专题启动日期为区间(去除补录数据)
	 * @param beginDateStr
	 * @param endDateStr
	 * @return
	 */
	 ...
	 * @return
	 */
	Boolean isExistByStudyNoReqNo(String studyNo, int reqNo);
	 ...
	 * @return
	 */
	TblAnatomyTask getByStudyNoReqNo(String studyNo, int reqNo);
	...
	/**查询该专题下，补录解剖任务列表（taskId,anatomyDate,animalNum,signer），补录解剖数据专用
	 * @param studyNo
	 * @return
	 */
