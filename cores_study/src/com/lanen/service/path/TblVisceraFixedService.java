...
public interface TblVisceraFixedService extends BaseDao<TblVisceraFixed>{
	...
	/**查询列表，根据sessionIds(会话ID列表)，animalCode(动物编号)，visceraName(脏器名称),加上缺失和自溶的
	 * @param sessionIds
	 * @param studyNoSelected
	 * @param animalCodeSelected
	 * @param visceraNameSelected 
	 ...
	 * @return
	 */
	List<Map<String,Object>> getNormallessListByStudyNoAndReqNo(String studyNo,int reqNo);
	...
	List<Map<String, Object>> getListByConditions2s(String taskId,
			String sessionId, String visceraName, String animalCode);
	/**
	 * 根据studyNo获取脏器固定，按脏器的snFixed排序
	 * @param studyNo
	 * @return
	 */
	List<TblVisceraFixed> getVisceraFixedByStudyNoAndReqNo(String studyNo,Integer reqNo,String visceraName);
	/**
	 * 根据studyNo获取脏器固定，按脏器的snFixed排序
	 * @param studyNo
	 * @return
	 */
	List<List<TblVisceraFixedCompare>> getVisceraFixedByStudyNoAndReqNo2(String studyNo,Integer reqNo,String visceraName);
	/**
	 * 根据studyNo获取脏器固定的脏器数据
	 * @param studyNo
	 * @return
	 */
	List<Map<String, Object>> getVisceraFixedVisceraByStudyNoAndReqNo(String studyNo,Integer reqNo);
