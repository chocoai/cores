...
public class TblStudyPlan   implements Serializable   {
	...
	private Date studyGroupingDate;		//试验分组日期
	...
	private int animalCodeMode ;        //1:A   2:B   3:C  手工编号
	...
	//9：报告完成
	//10：试验结束
	private Integer scheduleState;//新增的，日程的状态。日程的状态和整个专题的状态分开，
	//日程状态   0 未提交 1 提交 2 申请再编辑 3再编辑
	...
	public Date getStudyGroupingDate() {
		return studyGroupingDate;
	}
	public void setStudyGroupingDate(Date studyGroupingDate) {
		this.studyGroupingDate = studyGroupingDate;
	}
