...
public class TblAnatomyReqVisceraWeigh_Json implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2404681770365930146L;
    ...
    private int sn;          //序号
    private String attachedViscera;//附加脏器
	public String getId() {
		return id;
	}
