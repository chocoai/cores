        ...
        <div class="header" >
        	<div class="logo_box"  onmouseover="showSystembox();" onmouseout="hiddenSystembox();"><a href="#" class="logo" ></a>
            	<div id="system_box" class="system_box"  >
                        <div id="system" class="system">
                        	<span class="arr"></span>
                           <iframe	src="/cores_auserprivilege/userAction_menu.action?from=cores_study&userName=${userName}"  marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%" id="mainMenu" name="mainMenu"  >
                            </iframe>
            ...
            <div class="studyPlan">
            	<div style="position:relative;
						...
						margin-top:17px;
						">
				<b>专题编号：</b><span id="top_studyNo" style="display:-moz-inline-box; display:inline-block;min-width: 100px;"></span> 
				<b>项目负责人：</b><span id="top_sd" style="display:-moz-inline-box; display:inline-block;min-width: 50px;"></span>
