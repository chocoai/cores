...
<body>
	<div class="easyui-layout" fit="true" border="false" ">
		<div region="north" border="false"  style="height:26px;">
			<div class="page_tab">
		      <ul>
		          <li class="active"><span><span><a href="javascript:void(0);">生化指标-编辑</a></span></span></li>
		      </ul>
			</div>
		</div>
		<!-- table start -->
		<div region="center" border=false style="border: 1px solid #c8c8c8;">
			<!-- 工具栏（保存 返回）start -->
				...
				<!-- 工具栏结束 -->
			<form id="testIndexAddForm" action="dictBioChemAction_edit.action" method="post">
			<table width="400px;" style="margin-top: 20px;">
				...
				<tr>
					...
					<td><input  style="width:150px;"  missingMessage="必填项" invalidMessage="缩写已存在" 
						...
						validType="remote[sybp()+'/dictBioChemAction_checkOtherAbbr.action?oldAbbr=${abbr}','abbr']" 
