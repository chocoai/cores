...
<script type="text/javascript">
	...
	function onExitButton(){
		window.location.href=sybp()+'/dictBloodCoagAction_list.action';
	}
</script>
</head>
<body>
	<div class="easyui-layout" fit="true" border="false" ">
		<div region="north" border="false"  style="height:26px;">
			<div class="page_tab">
		      <ul>
		          <li class="active"><span><span><a href="javascript:void(0);">血凝指标-添加</a></span></span></li>
		      </ul>
			</div>
		</div>
		<!-- table start -->
		<div region="center" border=false style="border: 1px solid #c8c8c8;">
			<!-- 工具栏（保存 返回）start -->
				...
				<!-- 工具栏结束 -->
			<form id="testIndexAddForm" action="dictBloodCoagAction_add.action" method="post">
			<table width="400px;" style="margin-top: 20px;">
				<tr>
					...
					<td><input  style="width:150px;" missingMessage="必填项" invalidMessage="名称已存在" 
						...
						validType="remote[sybp()+'/dictBloodCoagAction_checkName.action','name']" 
				...
				<tr>
					...
					<td><input  style="width:150px;"  missingMessage="必填项" invalidMessage="缩写已存在" 
						class="easyui-validatebox" required="true" 
						validType="remote[sybp()+'/dictBloodCoagAction_checkAbbr.action','abbr']" 
						name="abbr" type="text"/></td>
				</tr>
				<tr>
					<td width="150px;" height="30px;" align="right">精度</td>
					<td><input  style="width:150px;"    class="easyui-numberbox" validType="nonnegativeInteger"  name="precision" type="text"/></td>
				</tr>
				<tr>
					<td width="150px;" height="30px;" align="right">单位</td>
					<td>
					<input class="easyui-combobox" name="unit"   style="width:100px;height:19px;" data-options="valueField:'id',textField:'text',
