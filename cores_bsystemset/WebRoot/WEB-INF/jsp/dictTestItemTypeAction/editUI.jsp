...
<body>
	<div class="easyui-layout" fit="true" border="false" ">
		<div region="north" border="false"  style="height:26px;">
			<div class="page_tab">
		      <ul>
		          <li class="active"><span><span><a href="javascript:void(0);">供试品类型-编辑</a></span></span></li>
		      </ul>
			</div>
		</div>
		<!-- table start -->
		<div region="center" border=false style="border: 1px solid #c8c8c8;">
			...
			<table width="400px;" style="margin-top: 20px;">
				<tr>
					...
					<td><input  style="width:250px;" missingMessage="必填项" invalidMessage="编码已存在" class="easyui-validatebox" required="true" readonly="readonly" name="tiCode" value="${tiCode}" type="text"/></td>
				</tr>
				<tr>
					<td width="150px;" height="30px;" align="center">供试品类型名称</td>
					<td><input  style="width:250px;"  missingMessage="必填项" invalidMessage="名称已存在" class="easyui-validatebox" required="true" validType="remote[sybp()+'/dictTestItemTypeAction_checkTiType.action?tiCode=${tiCode}','tiType']" name="tiType" value="${tiType}" type="text"/></td>
				</tr>
			</table>
			</form>
		</div>
