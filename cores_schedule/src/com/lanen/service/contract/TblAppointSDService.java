...
public interface TblAppointSDService extends BaseDao<TblAppointSD>  {
     ...
     * @return
     */
    Map<String,Object> getByNoFinishFileDis(Date startime,Date endtime,String name,String sort,String order,String tiNo,String chooseOwn,String page,String rows,String searchString);
