...
<!--header-->
        <div class="header" >
        	<div class="logo_box"  onmouseover="showSystembox();" onmouseout="hiddenSystembox();">
        	  <a href="#" class="logo" ></a>
            	<!-- 
            ...
            <div class="system_name">
            	<div class="name">灵长类实验动物资源管理系统</div>
                <div class="path">
                <!-- 
                    <ul>
                    <li class="icon"></li>
            ...
            <div class="quicklink">
                ...
                <li><a href="#" class="user"></a>
                	<div  class="dorpdown_box">
                        <div class="dorpdown">
                        	<span class="arr"></span>
                            <div class="title"><a >${user.name}&nbsp;&nbsp;欢迎您！</a></div>
                            <ul>
            ...
            <div class="principal_box">
            	<div class="principal"><b>当前用户：</b>${user.name}<span></span></div>
            </div>
            <div class="clear"></div>
        </div>
