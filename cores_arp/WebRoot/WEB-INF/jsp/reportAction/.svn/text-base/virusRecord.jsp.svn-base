...
<script type="text/javascript">
		...
		$('#SearchButton').searchbox({ 
			...
			searcher:function(value,name){ 
			 var monkeyId=$('#searchmonkeyid').val();
          	 var virusdate=$('#virusdate').datebox('getValue');
		     showVirusTable(monkeyId,virusdate);
			}, 
    ...
    function showVirusTable(monkeyid,virusdate){
    	$('#virusTable').datagrid({
			url : sybp()+'/virusAction_virusByJson.action?monkeyid='+monkeyid+'&cdate='+encodeURIComponent(virusdate),
			title:'',
			height:tableHeight,
			width:tableWidth,
     ...
     function onSearchButton(){
      ...
      function onPrintButton(){
        ...
        if(checkId!=""){
    		...
    		window.location.href=sybp()+'/virusAction_reportVirus.action?monkeyid='+monkeyid+'&virusdate='+virusdate+'&checkId='+checkId;
    	}else{
...
<div id="layoutMainDiv" class="easyui-layout"  style="width:100%;height:100%; display:none;"> 
 	<div region="center" title="" style="overflow: hidden;">
 	 	<!--  <div id="tabs" class="easyui-tabs" fit="true" border="false">-->
            <div title="病毒检测记录" border="false" style="overflow: auto;">
                <div style="height:30px;">
			       <div style="float:left; width:100%;padding-top:5px;height:22px;">
			    	    ...
			    	    &nbsp;&nbsp;&nbsp;&nbsp; 采样日期：
		                &nbsp;
			        	&nbsp;<input id="virusdate" type="text" class="easyui-datebox" style="width:100px;height:16px;" editable="false"></input>
