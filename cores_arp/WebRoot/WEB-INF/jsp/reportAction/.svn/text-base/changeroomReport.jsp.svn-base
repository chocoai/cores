...
<script type="text/javascript">
	...
	function onBackButton(){
		...
		if(toWhere == 'apply'){
			...
			window.location.href="${pageContext.request.contextPath}/changeroomAction_listChangeroom.action";
		}
	}
</script>
</head>
...
<div class="easyui-layout" fit="true">
	...
	<div region="center" fit="true" >
			<iframe id="ireport" name="ireport"  src="${pageContext.request.contextPath}/changeroomAction_changeroomByReport.action?changeroomDate=${changeroomdate}&monkeyid=${monkeyid}&ykeeper=${ykeeper}&xkeeper=${xkeeper}" style="border:0;width:100%;height:90%;" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
	</div>
</div>
