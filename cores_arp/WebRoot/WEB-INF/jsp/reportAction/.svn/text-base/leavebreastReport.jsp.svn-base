...
<script type="text/javascript">
	...
	function onBackButton(){
		...
		if(toWhere == 'apply'){
			...
			window.location.href="${pageContext.request.contextPath}/leavebreastAction_listLeavebreast.action?studyNoPara="
...
<div class="easyui-layout" fit="true">
	...
	<div region="center" fit="true" >
			<iframe id="ireport" name="ireport"  src="${pageContext.request.contextPath}/leavebreastAction_leavebreastByReport.action?leavebreastdate=${leavebreastdate}&monkeyid=${monkeyid}" style="border:0;width:100%;height:90%;" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
	</div>
</div>
