...
<script type="text/javascript">
    ...
    function showParasiteTable(monkeyid,parasitedate){
    	$('#parasiteTable').datagrid({
			url : sybp()+'/parasiteAction_inParasiteByJson.action?monkeyid='+monkeyid+'&cdate='+encodeURIComponent(parasitedate),
			title:'',
			height:tableHeight,
			width:tableWidth,
     ...
     function onSearchButton(){
      ...
      function onPrintButton(){
        ...
        if(checkId!=""){
    		...
    		window.location.href=sybp()+'/parasiteAction_reportInParasite.action?parasitedate='+parasitedate+'&monkeyid='+monkeyid+'&checkId='+checkId;
    	}else{
...
<div id="layoutMainDiv" class="easyui-layout"  style="width:100%;height:100%; display:none;"> 
 	<div region="center" title="" style="overflow: hidden;">
 	 	<!--  <div id="tabs" class="easyui-tabs" fit="true" border="false">-->
            <div title="寄生虫检测记录" border="false" style="overflow: auto;">
                <div style="height:30px;">
			       <div style="float:left; width:100%;padding-top:5px;height:22px;">
			    	    ...
			    	    &nbsp;&nbsp;&nbsp;&nbsp; 采样日期:
		                &nbsp;
			        	&nbsp;<input id="parasitedate" type="text" class="easyui-datebox" style="width:100px;height:16px;" editable="false"></input>
