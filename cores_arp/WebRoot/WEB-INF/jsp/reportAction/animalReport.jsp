...
<script type="text/javascript">
	...
	function onBackButton(){
		...
		window.location.href="${pageContext.request.contextPath}/areaAction_listAnimal.action";
	}
</script>
</head>
<body>
<div class="easyui-layout" fit="true">
	...
	<div region="center" fit="true" >
			<iframe id="ireport" name="ireport"  src="${pageContext.request.contextPath}/areaAction_animalByReport.action?keeper=${keeper}&blongarea=${blongarea}" style="border:0;width:100%;height:90%;" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
	</div>
</div>
