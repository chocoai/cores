...
public class Infectious_Json implements Serializable {

	/**
	 * 疫苗接种
	 */
	private static final long serialVersionUID = -5179096727364387917L;
	private Integer id;
	...
	public String getYpin() {
		return ypin;
	}
	public void setYpin(String ypin) {
		this.ypin = ypin;
	}
	...
	public void setDrugs_id(String drugs_id) {
	...
	public String getCrbmc() {
		return crbmc;
	}
	public void setCrbmc(String crbmc) {
		this.crbmc = crbmc;
	}
