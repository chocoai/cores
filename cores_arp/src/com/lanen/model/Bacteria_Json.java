...
public class Bacteria_Json implements Serializable {
	...
	public String getQconfig_name() {
		return qconfig_name;
	}
	public void setQconfig_name(String qconfig_name) {
		this.qconfig_name = qconfig_name;
	}	
