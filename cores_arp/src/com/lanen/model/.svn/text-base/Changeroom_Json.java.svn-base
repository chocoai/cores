...
public class Changeroom_Json implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7528990887670572040L;
    ...
    private String operater;     //档案录入//改为现饲养员名.
	...
	public void setYroomName(String yroomName) {
		this.yroomName = yroomName;
	}
	public String getYroomName() {
		return yroomName;
	}
	public void setYareaName(String yareaName) {
		this.yareaName = yareaName;
	}
