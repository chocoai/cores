...
public class Hospitaldl implements Serializable{
    ...
    private String zzmc;                //?
    private String cf;              //?
    private Integer treatveterinarian;           //删除标记
	...
	public Integer getTreatveterinarian() {
		return treatveterinarian;
	}
	public void setTreatveterinarian(Integer treatveterinarian) {
