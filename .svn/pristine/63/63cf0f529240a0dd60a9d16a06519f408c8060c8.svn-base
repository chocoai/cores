 ...
 *
 */
public class TblVisceraFixedCompare implements java.io.Serializable{

	private static final long serialVersionUID = -1113658117001069122L;
	...
	private String _fixedFlag ;
	private String _autolyzaFlag;
	private String _missFlag ;
	private String _missType ;
	private String missingRsn ;
	...
	public void set_fixedFlag(String fixedFlag) {
		_fixedFlag = fixedFlag;
	}
	public String get_missFlag() {
		return _missFlag;
	}
	public void set_missFlag(String missFlag) {
		_missFlag = missFlag;
	}
	public String get_missType() {
		return _missType;
	}
	public void set_missType(String missType) {
		_missType = missType;
	}
	...
	public void setMissingRsn(String missingRsn) {
		this.missingRsn = missingRsn;
	}
	public String get_autolyzaFlag() {
		return _autolyzaFlag;
	}
	public void set_autolyzaFlag(String autolyzaFlag) {
		_autolyzaFlag = autolyzaFlag;
	}
