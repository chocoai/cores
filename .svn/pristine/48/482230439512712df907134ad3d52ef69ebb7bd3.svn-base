...
public interface TblAnatomyCheckService extends BaseDao<TblAnatomyCheck> {
	 ...
	 * @return
	 */
	List<Map<String,Object>> getAnatomyCheckBySessionIDs(List<String> sessionID, String studyNoSelected, String animalCodeSelected, String visceraNameSelected);
	...
	List<Map<String, Object>> getListByConditions2WithEdits(String taskId,
			...
			String animalCode);
	/**
	 * 根据studyNo,reqId获取剖检信息.按脏器字典sn排序
	 * @param studyNo
	 * @return
	 */
	List<TblAnatomyCheck> getAnatomyCheckByStudyNoAndReqNo(String studyNo,Integer reqNo,String visceraName,String finding);
	/**
	 * 根据studyNo,reqId获取剖检脏器信息.按脏器字典sn排序
	 * @param studyNo
	 * @return
	 */
	List<Map<String, Object>> getAnatomyCheckVisceraByStudyNoAndReqNo(String studyNo,Integer reqNo);
	/**
	 * 根据studyNo,reqId获取剖检脏器信息.按脏器字典sn排序
	 * @param studyNo
	 * @return
	 */
	List<Map<String, Object>> getAnatomyCheckFindingByStudyNoAndReqNo(String studyNo,Integer reqNo);
