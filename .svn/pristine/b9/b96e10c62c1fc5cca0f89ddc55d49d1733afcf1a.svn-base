...
<link href="style/images/icon.png.png" rel="shortcut icon" />
...
<body>
	<div class="container">
        ...
        <div class="sidebar_box">
        	<iframe name="left" src="${pageContext.request.contextPath}/homeAction_leftSystemSet.action" width=100% height=100% frameborder=no border=0 marginwidth=0 marginheight=0 scrolling=no allowtransparency=yes></iframe>
        </div>
        <div class="mainbody2">
