...
<script type="text/javascript">
    	$(function(){
			...
			$('#tblFileContentStudyDatagrid').datagrid({
			...
			var pager = $('#tblFileContentStudyDatagrid').datagrid('getPager');    // get the pager of datagrid
		   	var opts = $('#tblFileContentStudyDatagrid').datagrid('options');
	    	pager.pagination({
	          showRefresh:false,
	          loading:true,
			 ...
			 parent.parent.$('#oneArchiveMaker').combobox({
				 valueField:'realName',
				 textField:'realName',
				 editable:false,
	 			 url:sybp()+'/tblFileContentStudyAction_getUserList.action'			 
			 });
			 parent.parent.$('#oneStorePosition').combotree({
				 valueField:'text',
				 textField:'text',
				 editable:true,
...
<body >
	<div class="container">
       ...
       <div style="display:block; position:absolute;top:0px;left:0px;right:0px; bottom:0px;background:#fff;padding:0px 0px 0px 0px;overflow:hidden;" >
 	 	 ...
 	 	 <div id="tblFileContentStudyDatagrid" class="easyui-datagrid" style="border: 1px solid #c8c8c8;" border="false" >
