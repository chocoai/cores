...
public interface TblTissueSliceIndexService extends BaseDao<TblTissueSliceIndex>{
	...
	/**查询该脏器下的子脏器列表， visceraType,visceraCode,visceraName,subVisceraCode,subVisceraName,gender,sn,subSn
	 * @param studyNo
	 * @param visceraCode
	 * @return
	 */
	...
	/**查询该脏器列表下的子脏器列表， visceraType,visceraCode,visceraName,subVisceraCode,subVisceraName,gender,sn,subSn
	 * @param studyNo
	 ...
	 * @return
	 */
	List<TblTissueSliceIndex> getAllSignedByTaskId(String taskId);
	/**
	 * 
	 * @param studyNo
	 * @return
	 */
	List<Map<String, Object>> getSliceAnimalByStudyNo(String studyNo);
