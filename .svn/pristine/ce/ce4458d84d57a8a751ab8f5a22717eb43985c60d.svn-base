 ...
 *  
 */
public class TblTestItemHis implements Serializable {

	private static final long serialVersionUID = 5973750247105315319L;
	...
	private String contentLabel;				// 含量
	...
	private Date validityPeriod;		// 有效期限
	private int isFailureDateFlag;		//是否是失效日期    默认值是  0  ,  0:有效期    1：失效期
	private int failureDatePrecision;	//精度（有效期限/失效期限）   1：年     2：年月    3：年月日    默认是  3
	...
	public int getIsFailureDateFlag() {
		return isFailureDateFlag;
	}
	public void setIsFailureDateFlag(int isFailureDateFlag) {
		this.isFailureDateFlag = isFailureDateFlag;
	}
	public int getFailureDatePrecision() {
		return failureDatePrecision;
	}
	public void setFailureDatePrecision(int failureDatePrecision) {
		this.failureDatePrecision = failureDatePrecision;
	}
