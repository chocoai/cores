...
<script type="text/javascript">
	...
	function onExitButton(){
		window.location.href=sybp()+'/dictBioChemAction_list.action';
	}
</script>
</head>
<body>
	<div class="easyui-layout" fit="true" border="false" ">
		<div region="north" border="false"  style="height:26px;">
			<div class="page_tab">
		      <ul>
		          <li class="active"><span><span><a href="javascript:void(0);">生化指标-添加</a></span></span></li>
		      </ul>
			</div>
		</div>
		<!-- table start -->
		<div region="center" border=false style="border: 1px solid #c8c8c8;">
			<!-- 工具栏（保存 返回）start -->
				...
				<!-- 工具栏结束 -->
			<form id="testIndexAddForm" action="dictBioChemAction_add.action" method="post">
			<table width="400px;" style="margin-top: 20px;">
				<tr>
					...
					<td><input  style="width:150px;" missingMessage="必填项" invalidMessage="名称已存在" 
						...
						validType="remote[sybp()+'/dictBioChemAction_checkName.action','name']" 
				...
				<tr>
					...
					<td><input  style="width:150px;"  missingMessage="必填项" invalidMessage="缩写已存在" 
						class="easyui-validatebox" required="true" 
						validType="remote[sybp()+'/dictBioChemAction_checkAbbr.action','abbr']" 
