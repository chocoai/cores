...
@Controller
@Scope("prototype")
public class TblFileContentGlpSynthesis2Action extends BaseAction<TblFileContentGlpSynthesis> {
	//基建
	/**
	 * 
	 */
	...
	public void save()
	{
		...
		if(!isExistArchiveCode)
		{
			...
			fileContentGlp.setBaseGlpFlag(2);//1是综合 2基建
	...
	public void appendSave()
	{
		...
		//{
			...
			fileContentGlp.setDepartment(department.getName());
			fileContentGlp.setDocName(model.getDocName());
			fileContentGlp.setBaseGlpFlag(2);
	...
	public void loadList()
	{
		...
		Map<String, Object> resultMap =tblFileContentGlpSynthesisService.getByCondition(departName,fileStartDate,fileEndDate,keepEndDate,isDestory,isValid,searchString,page,rows,2);
