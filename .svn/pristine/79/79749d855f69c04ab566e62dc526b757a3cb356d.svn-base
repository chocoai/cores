...
<script type="text/javascript">
    	$(function(){
    		...
    		var tableWidth  = document.body.clientWidth-2;
   	   	 	$('#tblFileContentEmployeeDatagrid').datagrid({
	           ...
	           // collapsible : true,//显示可折叠按钮 
				...
				onDblClickRow:function(rowIndex, rowData){//查看
					parent.parent.newOneEmployee(4);
				},
   	 	...
   	 	var pager = $('#tblFileContentEmployeeDatagrid').datagrid('getPager');    // get the pager of datagrid
	   	var opts = $('#tblFileContentEmployeeDatagrid').datagrid('options');
    	pager.pagination({
          showRefresh:false,
          loading:true,
          onSelectPage:function(pageNum, pageSize){
			...
			if(contentWind.$)
			 ...
			 parent.parent.$('#staffDept').combobox({
 					valueField:'name',
 					textField:'name',
 					 editable:false,
 	 				url:sybp()+'/tblFileContentEmployeeAction_getDeptmentList.action'			 
				 });
			 parent.parent.$('#oneArchiveMaker5').combobox({
 					 valueField:'realName',
 					 textField:'realName',
 					 editable:false,
			 ...
			 parent.parent.$('#oneStorePosition5').combotree({
				 valueField:'text',
				 textField:'text',
				 editable:true,
...
<body >
	<div class="container">
       ...
       <div style="display:block; position:absolute;top:0px;left:0px;right:0px; bottom:0px;background:#fff;padding:0px 0px 0px 0px;overflow:hidden;" >
 	 	 ...
 	 	 <div id="tblFileContentEmployeeDatagrid" class="easyui-datagrid" style="border: 1px solid #c8c8c8;" border="false" >
