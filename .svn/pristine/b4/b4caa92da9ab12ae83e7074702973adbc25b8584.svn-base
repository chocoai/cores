...
public interface TblVisceraWeightService extends BaseDao<TblVisceraWeight> {
	...
	/**
	 * 获取称重列表，按脏器的snWeight排序
	 * @param StudyNo
	 * @param reqId
	 * @param visceraName
	 * @return
	 */
	List<TblVisceraWeight> getVisceraWeightByStudyNoAndReqNo(String StudyNo,Integer reqNo,String visceraName);
	/**
	 * 获取称重的脏器列表
	 * @param studyNo
	 * @param reqNo
	 * @return
	 */
	List<Map<String, Object>> getVisceraWeightVisceraByStudyNoAndReqNo(String studyNo,Integer reqNo);
