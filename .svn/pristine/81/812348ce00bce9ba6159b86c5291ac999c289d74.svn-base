...
public interface TblHistopathCheckService extends BaseDao<TblHistopathCheck> {
	...
	/**查询待镜检动物,根据专题编号和动物编号列表(animalCode,gender,isNoAbnormal,resultNum)
	 * @param studyNo
	 ...
	 * histopathCheck.animalCode,histopathCheck.tissueSliceVisceraRecordId,histopathCheck.isNoAbnormal,histopathCheck.tumorFlag,
		 ...
		 * level,tumorNum,tumorPos,tumorOccurDate,"+
		tumorCharacter,remark,visceraCode
	 * @param studyNo
	...
	/**查询所有切片、动物、切片脏器Id，(map :sliceVisceraId,animalCode,visceraOrTissueName,visceraType,visceraCode,visceraFixedRecordId,"+
	 *	visceraName,subVisceraCode,subVisceraName,"+
	 *	specialFlag,anatomyPosCode,anatomyPos,anatomyFindingCode,"+
	 *	anatomyFindingFlag,anatomyFingding,bodySurfacePos)排除已排除的，性别不符的
	...
	/**获取当前已动物的已镜检脏器或组织列表(镜检时，登记缺失的去掉),map:animalCode,sliceVisceraId,visceraType,visceraCode,visceraFixedRecordId,visceraOrTissueName,
	 *		visceraName,subVisceraCode,subVisceraName,
	 *			specialFlag,anatomyPosCode,anatomyPos,anatomyFindingCode,
