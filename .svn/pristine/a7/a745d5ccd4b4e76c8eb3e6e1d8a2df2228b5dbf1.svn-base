...
public interface TblDoseSettingService extends BaseDao<TblDoseSetting> {
	 ...
	 * @return
	 */
	List<Map<String,Object>> getVerListByStudyNo(String studyNoPara);
	...
	/**获取TblDoseSettingLIst
	 * @param studyNoPara
	 * @return
	 */
	List<TblDoseSetting> getTblDoseSettingListByStudyNo(String studyNoPara);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getMapListByStudyNoAndVersion(String studyNoPara,Integer version);
	 ...
	 * @return
	 */
	List<TblDoseSetting> getListByStudyNoAndDate(String studyNo,Date reqCreateTime);
}
