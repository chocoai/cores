...
<script type="text/javascript">
    	$(function(){
    		...
    		var tableWidth  = document.body.clientWidth-2;
   	   	 	$('#tblFileContentContractDatagrid').datagrid({
	           ...
	           frozenColumns:[[
				...
				onLoadSuccess:function()
				{
					...
					parent.parent.newOneContract(4);
				},
   	   	...
   	   	var pager = $('#tblFileContentContractDatagrid').datagrid('getPager');    // get the pager of datagrid
	   	var opts = $('#tblFileContentContractDatagrid').datagrid('options');
    	pager.pagination({
          showRefresh:false,
          loading:true,
          onSelectPage:function(pageNum, pageSize){
			...
			if(contentWind.$)
			 ...
			 parent.parent.$('#oneArchiveMaker7').combobox({
				 valueField:'realName',
				 textField:'realName',
				 editable:false,
	 			 url:sybp()+'/tblFileContentStudyAction_getUserList.action'				 
			 });
			 parent.parent.$('#oneStorePosition7').combotree({
				 valueField:'text',
				 textField:'text',
				 editable:true,
...
<body >
	<div class="container">
       ...
       <div style="display:block; position:absolute;top:0px;left:0px;right:0px; bottom:0px;background:#fff;padding:0px 0px 0px 0px;overflow:hidden;" >
 	 	 ...
 	 	 <div id="tblFileContentContractDatagrid" class="easyui-datagrid" style="border: 1px solid #c8c8c8;" border="false" >
