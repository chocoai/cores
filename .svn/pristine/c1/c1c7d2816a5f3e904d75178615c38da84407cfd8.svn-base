...
public interface TblPathSessionService extends BaseDao<TblPathSession>{
	 ...
	 * @param userNameList
	 */
	void updateOperatorList(String sessionId, List<String> userNameList);

	/**查询会话id List，通过任务id(还未实现)
	 * @param taskId
	 * @return
	 */
	List<String> getSessionIdList(String taskId);
