...
public interface DictHematService extends BaseDao<DictHemat>{
	 ...
	 * @return
	 */
	List<DictHemat> findAllOrderByOrderNo();
	 ...
	 * @return
	 */
	DictHemat getByOrderNo(int orderNo); 
	/**根据 指标缩写  得到指标单位
	 * @param indexAbbr
	 * @return
	 */
