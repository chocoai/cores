...
public interface TblAnatomyReqAnimalListService extends BaseDao<TblAnatomyReqAnimalList> {
	...
	/**查询课题下动物是否已被申请解剖（解剖申请提交标志变为 1 ），如果已存在返回1，不存在返回0
	 * @param studyNo 
	 * @param animalCode
	 * @return
	 */
	...
	/**查询课题下所有可以被申请解剖的动物（已被申请(申请已提交的)的不能被再申请）(解剖前已死亡的可以继续选择)
	 * @param studyNoPara
	 * @return
	 */
	 ...
	 * @return
	 */
	List<TblAnatomyReqAnimalListHis> getHisListByStudyNoAndReqNo(
