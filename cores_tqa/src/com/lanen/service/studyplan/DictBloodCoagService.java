...
public interface DictBloodCoagService extends BaseDao<DictBloodCoag>{
	 ...
	 * @return
	 */
	List<DictBloodCoag> findAllOrderByOrderNo();
	 ...
	 * @return
	 */
	DictBloodCoag getByOrderNo(int orderNo); 
