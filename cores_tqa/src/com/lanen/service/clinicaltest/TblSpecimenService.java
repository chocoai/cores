...
public interface TblSpecimenService extends BaseDao<TblSpecimen>{
	...
	/**
	 * 根据    临检编号     检测项目     检测完成日期   设备id 查询
	 * @param specimenCode
	 * @param testItem
	 * @param collectionTime
	 * @return
	 */
	TblSpecimen getBySpecimenCodeTestItemTimeInstrumentId(String specimenCode,
			int testItem, String collectionTime,String instrumentId);
	/**
...
//	 * @return
//	 */
//	List<TblSpecimen> findByTblClinicalTestReqAndTestItems(TblClinicalTestReq tblClinicalTestReq,
//			Integer[] testItems);
	 ...
	 * @return
	 */
	List<?> findListByCondition(String studyNo, String reqNo, String animalId,
			String testItemString, String specimenCode, String recDate);
	/**
	 * 根据专题，申请和测试项目获取仪器Id
	 * @param studyNo
	 ...
	 * @return
	 */
	String getByStudyNoReqNoTestItem(String studyNo, int reqNo,int testItem);
}
