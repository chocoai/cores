...
public class QAChkPlan_JSON  implements java.io.Serializable {
	...
	private static final long serialVersionUID = 8771897014921459746L;
     ...
     private boolean haveChkPlanRight;
     private Integer studyReportState;
    ...
    /** default constructor */
    public QAChkPlan_JSON() {
    }

	/** minimal constructor */
    public QAChkPlan_JSON(String chkPlanId) {
        this.chkPlanId = chkPlanId;
    }
    
    /** full constructor */
    public QAChkPlan_JSON(String chkPlanId, QAStudyChkIndex qastudyChkIndex, String scheduleChkItemId, Integer chkPlanType, String chkItemId, String chkItemName, String taskNameId, String taskName, Date scheduleTime, String scheduleName, java.util.Date createTime, java.util.Date planChkTime, String planChkArea, Integer chkFinishedFlag, String planChkOperator, String chkOperator, java.util.Date chkTime, Integer chkPlanVersion) {
        this.chkPlanId = chkPlanId;
	...
	public boolean isHaveChkPlanRight() {
		return haveChkPlanRight;
	}

	public void setHaveChkPlanRight(boolean haveChkPlanRight) {
		this.haveChkPlanRight = haveChkPlanRight;
	}

	public Integer getStudyReportState() {
		return studyReportState;
	}

	public void setStudyReportState(Integer studyReportState) {
		this.studyReportState = studyReportState;
	}
	...
	public String getQuickOperate() {
		return quickOperate;
	}

	public void setQuickOperate(String quickOperate) {
		this.quickOperate = quickOperate;
	}
