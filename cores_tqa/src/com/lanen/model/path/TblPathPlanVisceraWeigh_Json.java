...
public class TblPathPlanVisceraWeigh_Json implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2125003457288850658L;
	 private String id;        //记录ID
	    ...
	    private int sn;          //序号
	    private String attachedViscera;  //附加脏器名（不止一个用逗号分隔）
		public String getId() {
			return id;
		}
		...
		public void setAttachedViscera(String attachedViscera) {
			this.attachedViscera = attachedViscera;
		}
		public String getAttachedViscera() {
			return attachedViscera;
		}
}
